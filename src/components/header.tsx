...
export const Header = () => {
    ...
    return (
        <div className="sticky top-0 w-full h-20 flex justify-center items-center z-50 px-10 lg:px-24">
            <div className={"bg-black rounded-xl px-5 py-3 flex justify-center items-center mt-2 lg:mt-0"}>
                <a
                ...
                <Button className={"p-5 rounded-lg"} variant={"secondary"} onClick={metamaskWalletHandler}>
                    {isWalletConnected ? addressFormat(account.address!) :"Connect your EVM wallet"}
                </Button>
            </div>
        </div>
    )
